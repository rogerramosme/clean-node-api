...
describe('SignUp Controller', () => {
  ...
  test('It should return 400 if no password confirmation fails', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('It should return 500 if AddAccount throws', () => {
  ...
  test('It should return 200 if valid data is provided', () => {
    const { sut } = makeSut()
